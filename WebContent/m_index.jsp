...
cookieName.setMaxAge(60*60*24*7);	//해당 데이터는 브라우저가 켜져있는 동안 적용되게 한다.괄호 안에 쿠키의 만료일 을 설정할 수 있다.
...
<%}%>
    ...
    <header class="site-header js-site-header">
      <div class="container-fluid">
        ...
        <!-- 로고 표시하는 부분 -->
          <div class="col-6 col-lg-4 site-logo" data-aos="fade"><a href="m_index.jsp" id="logo">JOA HOTEL</a></div>
...
눈부신 추억이 있습니다. 조아 호텔에서는 고객님 한 분, 한 분의 고귀한 삶을 아름답게 비춰 드리고자 합니다.</p>
            ...
            <a href="./Mobile_env/m_Welcome.jsp" class="btn btn-primary text-white py-2 mr-3" >more...</a>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-7">
            ...
            <button class="btn btn-primary btn-block text-white" onclick="location.href='./Mobile_env/Reservation/m_Reservation.jsp'">예약페이지</button>
            </p>
          </div>
        </div>
        <div class="row">
        ...
        <div class="container" >
          <div class="row align-items-center">
            ...
            <div class="col-12 col-md-6 text-center text-md-right" data-aos="fade-up" data-aos-delay="200">
              <a href="./Mobile_env/Reservation/m_Reservation.jsp" class="btn btn-outline-white-primary py-3 text-white px-5">Reserve Now</a>
            </div>
          </div>
        </div>
      </section>
