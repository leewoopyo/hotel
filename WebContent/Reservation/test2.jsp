...
<!-- 상당의 흰색 바를 나타내는 부분 -->
	...
	<!-- 반응형 설정을 위해  container 쿨래스를 가져옴 -->
      <div class="container-fluid">
        ...
        <!-- 제목 나타내는 영역 -->
          <div class="col-6 col-lg-4 site-logo" data-aos="fade"><a href="index.jsp">JOA HOTEL</a>
          <%
          try{
          if(session.getAttribute("login_ok").equals("yes")){ 
          %>
          	  <a href="./login/logout.jsp" style="position: fixed;left: 200%;width: fit-content;">LOG OUT</a></div>         
          <%
          }
          }catch(Exception e){
        	 e.printStackTrace(); 
