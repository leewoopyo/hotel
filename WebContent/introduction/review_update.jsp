...
List<BoardDTO> onelist = hoteldao.getonelist_review(id);
%>

<form action="review_update_logic.jsp" method="post">
<div class="container">
<table class="table table-bordered">
    <tbody>
            <tr>
                <th>제목: </th>
                <td><input type="text" placeholder="제목을 입력하세요." name="title" value="<%=onelist.get(0).getTitle() %>" class="form-control"/></td>
            </tr>
            <tr>
                <th>내용: </th>
                <td style="height:500px;">
                <textarea name="editor" id="content"><%=onelist.get(0).getContent() %></textarea>
                </td>
            </tr>
			<tr>
                <td colspan="2">
...
<input type="hidden" name="userid" value="<%=session.getAttribute("login_id")%>">
</form>
