          ...
          <!-- START slider -->
            <div class="home-slider major-caousel owl-carousel mb-5">
              <div class="slider-item">
                <a><img src="royal1.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a><img src="royal2.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a><img src="royal3.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a><img src="royal4.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
            </div>
            <!-- END slider -->
          </div>
						...
						<div class="tb-responsive view-type">
							<table class="rwd-table">
								...
								<tr>
									...
									<td><div class="td-txt">침실1(더블)+침실2(트윈)+거실+욕실2</div></td>
									<th scope="col">객실 면적</th>
									<td><div class="td-txt">109.5㎡(55평)</div></td>
								</tr>
								<tr>
									<th scope="col">객실 수</th>
									<td><div class="td-txt">4실</div></td>
									<th scope="col"></th>
							...
							<ul class="grid-area gap-4 col-sm-push">
								<li class="colum col-3">
									...
									<div class="desc">
										...
										<p>침대, 식탁의자, 쇼파, 식탁, TV, 전화기, 에어컨, 한실이불, 요</p>
									</div>
								</li>
								<li class="colum col-3">
								...
								<li class="colum col-3">
									...
									<div class="desc">
										...
										<p>연필, 빗자루, 쓰레받기, 주방세제, 빨래건조대, 욕실 쓰레기통, 음식물쓰레기통, 음식물쓰레기봉투(5L) 1EA, 욕실화, 소화기, 슬리퍼, 구둣주걱</p>
									</div>
								</li>
							</ul>
						</div>
