          ...
          <!-- START slider -->
            <div class="home-slider major-caousel owl-carousel mb-5">
              <div class="slider-item">
                <a><img src="standard1.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a><img src="standard2.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a><img src="standard3.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
            </div>
            <!-- END slider -->
          </div>
						...
						<div class="tb-responsive view-type">
							<table class="rwd-table">
								...
								<tr>
									...
									<td><div class="td-txt">3명</div></td>
									<th scope="col">최대 인원</th>
									<td><div class="td-txt">3명</div></td>
								</tr>
								<tr>
									<th scope="col">객실 구성</th>
									<td><div class="td-txt">원룸(더블+싱글)+욕실</div></td>
									<th scope="col">객실 면적</th>
									<td><div class="td-txt">36.5㎡(18평)</div></td>
								</tr>
								<tr>
									<th scope="col">객실 수</th>
									<td><div class="td-txt">10실</div></td>
									<th scope="col"></th>
							...
							<ul class="grid-area gap-4 col-sm-push">
								...
								<li class="colum col-3">
									...
									<div class="desc">
										...
										<p>샴푸, 샤워젤, 비누, 욕실컵, 바디스펀지, 헤어드라이기, 페이스타올, 욕조</p>
									</div>
								</li>
								<li class="colum col-3">
