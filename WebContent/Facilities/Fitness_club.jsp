...
<!-- container row col은 반응형 웹을 만들기 위한 CSS -->
	...
	<div class="container" data-aos="fade-up">
		<div class="row justify-content-center text-center mb-5">
			<div class="col-md-7">
			<!-- 해당 컨텐츠의 제목 부분 -->
				<h2 class="heading">Fitness club</h2>
				<p>푸른바다를 내려다보며 운동을 즐길 수 있는 곳으로 투숙객 누구나 이용할 수 있습니다.</p>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				<div class="mb-5">
				<!-- 그림 출력  -->
					<a><img src="Fitness_club.jpg" alt=""
	...
	<div class="room-view-area">
		...
		<!-- data-aos : fade-up은 데이터 로드 시 위로 올라오는 이펙트를 준다. -->
			<div class="tb-responsive view-type" data-aos="fade-up" style="border-top: 0px;">
				<table class="rwd-table" style="margin-left: 13%; width: 74%; height: 80%;">
					<colgroup>
						<col style="width: 15%">
						<col style="width: 25%">
						<col style="width: 15%">
					...
					<tbody>
						<tr style="border-top: 2px solid #aaa;">
							...
							<td><div class="td-txt">2층</div></td>
						</tr>
						<tr>
							<th scope="col"><ion-icon name="time"></ion-icon>&nbsp;운영시간</th>
							<td><div class="td-txt">07:00~22:00</div></td>
						</tr>
						<tr>
